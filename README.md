# Minimalistic Portfolio WordPress Theme

A modern, fast, and minimalistic WordPress block theme tailored for showcasing developer and designer portfolios. 
...
If you are a reviewer or developer wanting to test this theme inside WordPress:
...
4. **Site Editor**:
   * As a block theme, you can customize all templates and parts by going to `Appearance` -> `Editor`.
...
1. Make sure your local WordPress is running on XAMPP.
2. Make your edits or publish new posts in your WordPress admin panel.
3. Run `deploy.bat` to automatically build and push the updates live to GitHub Pages.
