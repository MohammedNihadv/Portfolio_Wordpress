 ...
 * Slug: minimalistic-portfolio/template-archive-product
 * Categories: template
 */
...
<div class="wp-block-column" style="flex-basis:66.666%"><!-- wp:query-title {"type":"archive","textAlign":"center","showPrefix":false,"align":"wide","fontFamily":"outfit"} /-->

<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:woocommerce/breadcrumbs {"align":"","className":"bt-woo-breadcrumb bt-woo-breadcrumb-center","textColor":"pure-white","fontFamily":"outfit","style":{"elements":{"link":{"color":{"text":"var:preset|color|pure-white"}}}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-columns"><!-- wp:column {"width":"70%","fontFamily":"outfit"} -->
<div class="wp-block-column has-outfit-font-family" style="flex-basis:70%"><!-- wp:woocommerce/store-notices /-->

<!-- wp:group {"fontFamily":"outfit","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group has-outfit-font-family"><!-- wp:woocommerce/product-results-count /-->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar-shop","theme":"minimalistic-portfolio"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group --></main>
<!-- /wp:group --></main>
