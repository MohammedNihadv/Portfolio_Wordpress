 ...
 * Slug: minimalistic-portfolio/template-search
 * Categories: template
 */
...
<div class="wp-block-query"><!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"fontFamily":"outfit","layout":{"type":"grid","columnCount":3}} -->
...
<!-- wp:query-no-results {"fontFamily":"outfit"} -->
...
<p class="has-text-align-center has-large-font-size"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Try another search?', 'minimalistic-portfolio' ); ?></p>
<!-- /wp:paragraph -->
