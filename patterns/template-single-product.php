 ...
 * Slug: minimalistic-portfolio/template-single-product
 * Categories: template
 */
...
<div class="wp-block-cover alignfull" style="margin-bottom:0;padding-top:0;padding-bottom:0px;min-height:300px"><img class="wp-block-cover__image-background wp-image-79" alt="" src="<?php echo esc_url($minimalistic_portfolio_images[0]); ?>" style="object-position:50% 0%" data-object-fit="cover" data-object-position="50% 0%"/><span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim-80 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","level":1,"fontFamily":"outfit"} -->
<h1 class="wp-block-heading has-text-align-center has-outfit-font-family"><?php echo esc_html__( 'Single Product', 'minimalistic-portfolio' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->

<!-- wp:group {"fontFamily":"outfit","layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-group has-outfit-font-family"><!-- wp:woocommerce/breadcrumbs /-->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related products', 'minimalistic-portfolio' ); ?></h2>
<!-- /wp:heading -->
