 ...
 * Slug: minimalistic-portfolio/template-page-no-gap
 * Categories: template
 */
...
<div class="wp-block-column" style="flex-basis:66.666%"><!-- wp:post-title {"textAlign":"center","level":1,"textColor":"accent-text","fontFamily":"outfit"} /--></div>
<!-- /wp:column -->
...
<!-- wp:post-content {"fontFamily":"outfit","layout":{"type":"default"}} /--></main>
<!-- /wp:group --></main>
<!-- /wp:group -->
