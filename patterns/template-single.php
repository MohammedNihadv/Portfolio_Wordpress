 ...
 * Slug: minimalistic-portfolio/template-single
 * Categories: template
 */
...
<div class="wp-block-group has-outfit-font-family" style="padding-top:0;padding-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:post-featured-image /-->
